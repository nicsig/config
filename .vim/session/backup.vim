...
argglobal
if bufexists('~/.vim/doc/misc/galore') | buffer ~/.vim/doc/misc/galore | else | edit ~/.vim/doc/misc/galore | endif
setlocal fdm=expr
...
setlocal fdn=20
setlocal fen
let s:l = 377 - ((23 * winheight(0) + 13) / 27)
