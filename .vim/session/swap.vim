...
" badd +1 ~/Dropbox/vim_plugins/swap_bis.vim
argglobal
silent! argdel *
...
wincmd w
argglobal
if bufexists('/usr/local/share/vim/vim81/doc/usr_11.txt') | buffer /usr/local/share/vim/vim81/doc/usr_11.txt | else | edit /usr/local/share/vim/vim81/doc/usr_11.txt | endif
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
