...
wincmd w
argglobal
if bufexists('~/wiki/logic/logic.md') | buffer ~/wiki/logic/logic.md | else | edit ~/wiki/logic/logic.md | endif
setlocal fdm=expr
setlocal fde=fold#md#fde#stacked()
setlocal fmr={{{,}}}
setlocal fdi=#
...
wincmd w
argglobal
if bufexists('~/wiki/weechat/abjects.md') | buffer ~/wiki/weechat/abjects.md | else | edit ~/wiki/weechat/abjects.md | endif
setlocal fdm=expr
setlocal fde=fold#md#fde#stacked()
setlocal fmr={{{,}}}
setlocal fdi=#
...
setlocal fdn=20
setlocal fen
let s:l = 331 - ((330 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
331
...
exe '2resize ' . ((&lines * 28 + 16) / 33)
tabnext
edit ~/Dropbox/vim_plugins/pair_complete.vim
set splitbelow splitright
wincmd t
set winminheight=0
set winheight=1
...
setlocal fdn=20
setlocal fen
let s:l = 136 - ((129 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
136
...
684
normal! zo
let s:l = 895 - ((185 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
895
...
wincmd w
argglobal
if bufexists('~/wiki/shell/redirection.md') | buffer ~/wiki/shell/redirection.md | else | edit ~/wiki/shell/redirection.md | endif
setlocal fdm=expr
setlocal fde=fold#md#fde#stacked()
setlocal fmr={{{,}}}
setlocal fdi=#
...
1088
normal! zo
let s:l = 714 - ((6 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
714
...
setlocal fdn=20
setlocal fen
let s:l = 813 - ((82 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
813
