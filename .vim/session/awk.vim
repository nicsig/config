...
argglobal
let s:l = 1569 - ((7 * winheight(0) + 0) / 0)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1569
...
wincmd w
argglobal
if bufexists("~/wiki/vim/terminal.md") | buffer ~/wiki/vim/terminal.md | else | edit ~/wiki/vim/terminal.md | endif
