...
let s:l = 5312 - ((4 * winheight(0) + 0) / 0)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
5312
...
argglobal
if bufexists("~/wiki/vim/config.md") | buffer ~/wiki/vim/config.md | else | edit ~/wiki/vim/config.md | endif
let s:l = 1718 - ((638 * winheight(0) + 0) / 0)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1718
...
argglobal
if bufexists("~/wiki/vim/complete.md") | buffer ~/wiki/vim/complete.md | else | edit ~/wiki/vim/complete.md | endif
let s:l = 443 - ((316 * winheight(0) + 0) / 0)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
443
...
exe '4resize ' . ((&lines * 0 + 16) / 33)
argglobal
let s:l = 19 - ((3 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
19
...
let s:l = 190 - ((15 * winheight(0) + 0) / 0)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
190
...
argglobal
let s:l = 501 - ((267 * winheight(0) + 0) / 0)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
501
...
let s:l = 139 - ((25 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
139
...
exe '2resize ' . ((&lines * 29 + 16) / 33)
tabnext
edit ~/.vim/plugged/vim-man/.git/index
set splitbelow splitright
wincmd _ | wincmd |
split
1wincmd k
...
wincmd w
argglobal
if bufexists("~/.vim/plugged/vim-man/.git/COMMIT_EDITMSG") | buffer ~/.vim/plugged/vim-man/.git/COMMIT_EDITMSG | else | edit ~/.vim/plugged/vim-man/.git/COMMIT_EDITMSG | endif
...
badd +1 /tmp/vim.vim
badd +0 ~/.vim/plugin/fzf.vim
badd +494 ~/.vim/plugged/vim-window/plugin/window.vim
badd +0 ~/.vim/plugged/vim-man/.git/index
badd +0 ~/.vim/plugged/vim-man/.git/COMMIT_EDITMSG
