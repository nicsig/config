...
wincmd w
argglobal
if bufexists("~/.vim/plugged/vim-vim/autoload/vim/refactor/if.vim") | buffer ~/.vim/plugged/vim-vim/autoload/vim/refactor/if.vim | else | edit ~/.vim/plugged/vim-vim/autoload/vim/refactor/if.vim | endif
...
let s:l = 23 - ((6 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
23
...
wincmd w
argglobal
if bufexists("~/bin/my_repo_are_they_dirty.sh") | buffer ~/bin/my_repo_are_they_dirty.sh | else | edit ~/bin/my_repo_are_they_dirty.sh | endif
...
" badd +5629 ~/.vim/vimrc
" badd +318 ~/bin/upp
" badd +0 ~/bin/my_repo_are_they_dirty.sh
