...
argglobal
balt ~/Desktop/ask.md
let s:l = 899 - ((168 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 899
...
let s:l = 50 - ((47 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 50
...
if bufexists("~/wiki/vim/config.md") | buffer ~/wiki/vim/config.md | else | edit ~/wiki/vim/config.md | endif
balt ~/.vim/plugged/vim-completion/plugin/completion.vim
let s:l = 1537 - ((0 * winheight(0) + 0) / 0)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 1537
...
let s:l = 76 - ((75 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 76
...
let s:l = 155 - ((8 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 155
...
let s:l = 2713 - ((7 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 2713
...
let s:l = 52 - ((13 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 52
...
balt ~/wiki/bug/vim.md
let s:l = 1394 - ((0 * winheight(0) + 0) / 0)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 1394
...
exe '2resize ' . ((&lines * 0 + 16) / 33)
argglobal
let s:l = 178 - ((72 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 178
...
exe '3resize ' . ((&lines * 0 + 16) / 33)
tabnext
edit ~/.vim/plugged/vim-bullet-list/.git/index
set splitbelow splitright
wincmd _ | wincmd |
split
wincmd _ | wincmd |
...
keepjumps 1
normal! 0
lcd ~/.vim/plugged/limelight.vim
wincmd w
argglobal
if bufexists("~/.vim/plugged/vim-capslock/.git/index") | buffer ~/.vim/plugged/vim-capslock/.git/index | else | edit ~/.vim/plugged/vim-capslock/.git/index | endif
...
wincmd w
argglobal
if bufexists("~/.vim/plugged/vim-capslock/.git/COMMIT_EDITMSG") | buffer ~/.vim/plugged/vim-capslock/.git/COMMIT_EDITMSG | else | edit ~/.vim/plugged/vim-capslock/.git/COMMIT_EDITMSG | endif
balt ~/.vim/tmp/gitcommit_messages/2019-08-20__10-59-49.txt
...
badd +61 ~/.vim/plugged/vim-vim/after/ftplugin/vim.vim
badd +1 ~/.vim/plugin/README/matchup.md
badd +1 ~/Desktop/cwd.md
badd +315 ~/.vim/plugged/vim-unix/autoload/unix.vim
...
badd +765 ~/wiki/bug/vim.md
badd +1 ~/wiki/vim/todo/todo.md
badd +1694 ~/wiki/vim/config.md
badd +11 ~/wiki/vim/complete.md
badd +69 ~/Desktop/vim.vim
badd +157 ~/.vim/plugin/matchup.vim
badd +60 ~/.vim/plugged/vim-fex/ftplugin/fex.vim
badd +119 ~/wiki/vim/shell.md
badd +162 ~/.vim/plugged/vim-completion/autoload/completion.vim
badd +53 ~/.vim/plugged/vim-completion/autoload/completion/util.vim
badd +102 ~/.vim/plugged/vim-vim/autoload/vim/refactor/substitute.vim
...
badd +1495 ~/.vim/plugged/vim-fuzzy/autoload/fuzzy.vim
badd +192 ~/.vim/plugged/vim-lg-lib/import/lg.vim
badd +1 ~/Desktop/filez
badd +1040 ~/.vim/autoload/myfuncs.vim
badd +14 ~/.vim/plugged/vim-comment/autoload/comment/util.vim
badd +0 ~/.vim/plugged/vim-bullet-list/.git/index
badd +0 ~/.vim/plugged/vim-capslock/.git/index
badd +0 ~/.vim/plugged/vim-capslock/.git/COMMIT_EDITMSG
