...
argglobal
let s:l = 708 - ((85 * winheight(0) + 0) / 0)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
708
...
let s:l = 753 - ((14 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
753
...
badd +7314 ~/.vim/vimrc
badd +458 ~/.vim/autoload/myfuncs.vim
...
badd +54 ~/.vim/plugged/vim-fold/plugin/fold.vim
