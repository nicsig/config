...
let s:l = 337 - ((11 * winheight(0) + 12) / 24)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
337
...
" badd +337 ~/.vim/plugged/vim-lg-lib/autoload/lg/window.vim
" badd +68 ~/.vim/plugged/vim-vim/autoload/vim/refactor/if.vim
" badd +25 ~/Desktop/vim.vim
