...
exe '3resize ' . ((&lines * 0 + 16) / 33)
argglobal
let s:l = 55 - ((54 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
55
...
exe '4resize ' . ((&lines * 0 + 16) / 33)
argglobal
let s:l = 245 - ((123 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
245
...
argglobal
let s:l = 1566 - ((0 * winheight(0) + 0) / 0)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1566
...
let s:l = 9133 - ((9 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
9133
...
let s:l = 899 - ((13 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
899
...
wincmd =
argglobal
let s:l = 527 - ((378 * winheight(0) + 0) / 0)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
527
...
badd +224 ~/.vim/plugged/vim-unix/autoload/unix.vim
...
badd +1090 ~/.vim/plugged/vim-completion/autoload/completion.vim
...
badd +1566 ~/wiki/vim/mapping.md
badd +208 ~/wiki/vim/todo/todo.md
badd +1 ~/.vim/plugged/vim-cmdline/autoload/cmdline/tab.vim
badd +225 ~/.vim/vimrc
badd +900 ~/.fzf/plugin/fzf.vim
badd +19 ~/.vim/plugin/fzf.vim
badd +527 ~/.vim/plugged/vim-repeat/autoload/repeat.vim
