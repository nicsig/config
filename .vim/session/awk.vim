...
wincmd =
argglobal
let s:l = 9131 - ((0 * winheight(0) + 0) / 0)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
9131
...
wincmd w
argglobal
if bufexists("~/bin/vim-anywhere.sh") | buffer ~/bin/vim-anywhere.sh | else | edit ~/bin/vim-anywhere.sh | endif
