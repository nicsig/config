...
let s:l = 104 - ((22 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
104
...
let s:l = 293 - ((292 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
293
...
let s:l = 1280 - ((51 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1280
...
let s:l = 613 - ((22 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
613
...
let s:l = 653 - ((12 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
653
...
let s:l = 23 - ((6 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
23
...
argglobal
let s:l = 735 - ((98 * winheight(0) + 0) / 0)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
735
...
wincmd w
argglobal
if bufexists("~/.config/keyboard/setup") | buffer ~/.config/keyboard/setup | else | edit ~/.config/keyboard/setup | endif
