...
349
normal! zo
let s:l = 122 - ((121 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
122
...
1133
normal! zo
let s:l = 1158 - ((0 * winheight(0) + 0) / 0)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1158
...
1313
normal! zc
let s:l = 622 - ((621 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
622
...
badd +475 ~/Desktop/bug.md
badd +853 ~/wiki/tmux/command.md
badd +698 ~/wiki/tmux/todo.md
badd +0 ~/.tmux.conf
