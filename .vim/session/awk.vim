...
3266
normal! zo
let s:l = 4507 - ((825 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
4507
...
164
normal! zo
let s:l = 150 - ((136 * winheight(0) + 0) / 0)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
150
...
84
normal! zo
let s:l = 113 - ((13 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
113
...
1264
normal! zo
let s:l = 1280 - ((175 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1280
...
581
normal! zo
let s:l = 671 - ((15 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
671
...
setlocal fdn=20
setlocal fen
let s:l = 220 - ((26 * winheight(0) + 0) / 1)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
220
...
setlocal fdn=20
setlocal fen
let s:l = 130 - ((129 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
130
