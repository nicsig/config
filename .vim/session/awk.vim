...
let s:l = 85 - ((83 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
85
...
badd +29 ~/.vim/plugged/vim-unix/autoload/unix.vim
...
badd +41 ~/.vim/plugged/vim-lg-lib/autoload/lg/popup.vim
badd +40 ~/.vim/plugged/vim-lg-lib/autoload/lg/popup/vim.vim
