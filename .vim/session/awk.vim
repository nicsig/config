...
let s:l = 76 - ((13 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
76
...
set winwidth=1
argglobal
let s:l = 229 - ((217 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
229
...
1
normal! 0
lcd ~/.vim/plugged/vim-completion/.git
wincmd w
3wincmd w
wincmd =
tabnext 14
...
" badd +252 ~/.vim/plugged/vim-completion/plugin/completion.vim
