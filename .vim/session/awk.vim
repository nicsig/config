...
3317
normal! zo
let s:l = 4497 - ((1035 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
4497
...
172
normal! zo
let s:l = 204 - ((20 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
204
...
setlocal fdn=20
setlocal fen
let s:l = 375 - ((189 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
375
...
setlocal fdn=20
setlocal fen
let s:l = 147 - ((131 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
147
...
768
normal! zo
let s:l = 772 - ((13 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
772
...
badd +150 ~/bin/yank
badd +217 ~/Desktop/tmux_Y_bug.md
