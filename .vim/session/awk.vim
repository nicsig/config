...
argglobal
if bufexists("~/wiki/vim/config.md") | buffer ~/wiki/vim/config.md | else | edit ~/wiki/vim/config.md | endif
let s:l = 1533 - ((0 * winheight(0) + 0) / 0)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1533
...
exe '2resize ' . ((&lines * 29 + 16) / 33)
tabnext
edit ~/.vim/plugged/vim-cookbook/autoload/cookbook/float/terminal.vim
set splitbelow splitright
wincmd _ | wincmd |
split
1wincmd k
...
wincmd w
argglobal
if bufexists("~/.vim/plugged/vim-cookbook/autoload/cookbook/float/border.vim") | buffer ~/.vim/plugged/vim-cookbook/autoload/cookbook/float/border.vim | else | edit ~/.vim/plugged/vim-cookbook/autoload/cookbook/float/border.vim | endif
...
badd +1055 ~/.vim/autoload/myfuncs.vim
...
badd +1 ~/Desktop/test1.vim
badd +35 ~/.vim/plugged/vim-cookbook/autoload/cookbook/float/border.vim
badd +14 ~/.vim/plugged/vim-cookbook/autoload/cookbook/float/terminal.vim
