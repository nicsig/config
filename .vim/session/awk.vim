...
arglocal
%argdel
let s:l = 394 - ((363 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
394
...
arglocal
%argdel
let s:l = 86 - ((14 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
86
...
badd +394 ~/Desktop/text-properties.md
badd +111 ~/Desktop/toggle_term.vim
