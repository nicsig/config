...
3317
normal! zo
let s:l = 4497 - ((822 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
4497
...
172
normal! zo
let s:l = 204 - ((21 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
204
...
setlocal fdn=20
setlocal fen
let s:l = 375 - ((207 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
375
...
setlocal fdn=20
setlocal fen
let s:l = 147 - ((146 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
147
...
84
normal! zo
let s:l = 105 - ((8 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
105
...
setlocal fdn=20
setlocal fen
let s:l = 146 - ((30 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
146
...
674
normal! zo
let s:l = 771 - ((61 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
771
...
1
normal! zo
let s:l = 81 - ((9 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
81
...
1
normal! 0
lcd ~/.vim/plugged/vim-capslock/.git
wincmd w
2wincmd w
wincmd =
tabnext 15
...
badd +771 ~/.tmux.conf
badd +84 ~/.vim/autoload/myfuncs.vim
