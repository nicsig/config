...
5572
normal! zo
let s:l = 7529 - ((0 * winheight(0) + 0) / 1)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
7529
...
wincmd w
argglobal
if bufexists('~/wiki/vim/utility.md') | buffer ~/wiki/vim/utility.md | else | edit ~/wiki/vim/utility.md | endif
setlocal fdm=expr
setlocal fde=fold#md#fde#stacked()
setlocal fmr={{{,}}}
setlocal fdi=#
