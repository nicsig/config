...
setlocal fdn=20
setlocal fen
let s:l = 1850 - ((12 * winheight(0) + 0) / 1)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1850
...
setlocal fdn=20
setlocal fen
let s:l = 590 - ((24 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
590
...
setlocal fdn=20
setlocal fen
let s:l = 762 - ((341 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
762
...
10
normal! zo
let s:l = 16 - ((10 * winheight(0) + 12) / 24)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
16
