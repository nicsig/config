...
xno ii <c-\><c-n><cmd>call <sid>InIndentation()<cr>
# indentation level and any surrounding empty lines
xno ai <c-\><c-n><cmd>call <sid>AroundIndentation()<cr>

ono ii <cmd>call <sid>InIndentation()<cr>
ono ai <cmd>call <sid>AroundIndentation()<cr>
...
def AroundIndentation() #{{{1
    ...
    # find first match (backwards & don't wrap or move cursor)
    var start: number = search(pat, 'Wbn') + 1
