...
--
-- remplacer p4p1                           par le nom de l'interface réseau à surveiller
-- /media/jean/HDD-INT-500G     par le chemin vers la partition à surveiller
-- caption='HDD'                        par caption='<nom de la partition>'
--
-- pour modifier les positions des différents graphiques, chercher y=
--               la largeur des graphiques,                        graph_thickness
--               les chiffres autour des graphiques,               text_size et text_radius
--==============================================================================
...
{
    name='fs_used_perc',           arg='/media/jean/HDD-INT-500G',                     max_value=100,
    x=70,                          y=600,
    graph_radius=42,
    graph_thickness=10,
    graph_start_angle=180,
